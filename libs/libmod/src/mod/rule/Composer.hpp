...
// rst:
struct MOD_DECL Composer {
	// rst: 	.. function:: Composer(const std::unordered_set<std::shared_ptr<Rule>> &database, LabelSettings labelSettings)
	// rst:
	...
	// rst:		.. function:: Composer(Composer &&) = delete
	Composer(Composer &&) = delete;
	// rst:		.. function:: Composer &operator=(Composer &&) = delete
	...
	// rst: 	.. function:: const std::unordered_set<std::shared_ptr<Rule>> &getCreatedRules() const
	// rst:
