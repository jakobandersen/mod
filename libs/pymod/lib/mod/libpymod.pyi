...
class _Func_VoidDGVertex:
	def __call__(self, v: DGVertex) -> None: ...
...
class _Func_PairDoubleBoolDGHyperEdge:
	def __call__(self, e: DGHyperEdge) -> Tuple[float, bool]: ...
...
class DG:
	...
	def build(self,
		onNewVertex: Optional[Callable[[DGVertex], None]]=None,
		onNewHyperEdge: Optional[Callable[[DGHyperEdge], None]]=None): ...
